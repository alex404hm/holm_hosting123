  ...
  return (
    <section class="flex mx-auto max-w-7xl px-6 items-center justify-center  min-h-[calc(100svh)] pt-[72px]">
      <div class="my-10 space-y-3 min-h-[60px]">
        <h1 class="text-4xl font-bold">ROCN PRIVACY POLICY</h1>
        ...
        <ul class="pl-10 list-disc list-inside">
          ...
          <li>To enforce applicable user agreements or policies, including our Terms of Service accessible at <a href="/terms">racnhosting.com/terms</a>; and to protect us, our users or the public from harm or illegal activities;</li>
          <li>In connection with any merger, sale of Holm Host assets, financing or acquisition of all or a portion of our business to another company;</li>
